...
export const env = {
  ...
  MONGODB_URI: process.env.MONGODB_URI || "mongodb+srv://AUeventmanager:Jai2005@cluster0.zngygka.mongodb.net/sikho-ai-test?retryWrites=true&w=majority",
  ...
  AVM_ADDRESS: process.env.AVM_ADDRESS || "HRKKD325GRHZN6PQYTDZP6N2PNKGC2XECOHY5JLTCTZLTYDMZT4PAEKH3M",
